...
export const loadParamsCards = createAction('[More Cards Component | Cards Resolver] Load filtered cards', props<{size: number, filter: string, page: number, actionType: string}>());
